...
export default async function Home({
  ...
  const tweets = await db
    ...
    .from(tweetsTable)
    .where(and(isNull(tweetsTable.replyToTweetId),sql`LOWER(content) LIKE LOWER(${`%${q}%`})`))
  ...
  // Check if a search query is provided and filter tweets if it is
  return (
    <>
      <div className="flex h-screen w-full max-w-2xl flex-col overflow-scroll pt-2">
      <div className="flex items-center justify-center">
  <h1 className="mb-2 bg-white px-4 text-xl font-bold">
    Join Me!&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;最牛逼的拼团软件
  </h1>
</div>
